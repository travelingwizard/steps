...
UI.PopUpAbout = function()
{
    ...
    $builder.append($("<p>",  {"class" : "legalese", "html" : "John Burroughs, Jonathan Barrette, Matthew Holtz, Matthew Ward, Michael Olsen, Péter Simon, Randi Rasmussen, Rob Porter"}));
    $builder.append($("<p>",  {"class" : "legalese", "html" : "Ann Louise Gottlieb, Jeppe Hansen, Mads Boie Pedersen, Dominik Ziga, Lars Thorsen"}));
    $builder.append($("<p>",  {"class" : "About", "html" : "&nbsp;"}));
    $builder.append($("<p>",  {"class" : "About", "html" : "Character Portraits: Kirstine Wistrup, Maike Gerstenkorn, Rafael Winniger, Sade"}));
    $builder.append($("<p>",  {"class" : "About", "html" : "&nbsp;"}));
    ...
    $builder.append($("<p>",  {"class" : "About", "html" : "&nbsp;"}));
    $builder.append($("<p>",  {"class" : "legalese", "html" : "Steps is written in Sublime Text using html and js with jQuery, lodash, uuidv4, Bowser, and AutoComplete libraries."}));
    $builder.append($("<p>",  {"class" : "About", "html" : "&nbsp;"}));
